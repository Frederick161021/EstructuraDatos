                    ...
                    switch(seleccion){
                        case 1:
                            if (placas.peek().equalsIgnoreCase(eAuto)) {
                                ...
                                LinkedList <String> placasTemp = new LinkedList <>();
                                topPlaca = placas.peek();
                                do{
                                    placasTemp.add(placas.peek());
                                    placas.pop();
                                }while(placas.peek().equalsIgnoreCase(eAuto) == false );
                                placas.pop();
                                    do {
                                    placas.push(placasTemp.getFirst());
                                    placasTemp.poll();
    ...
    public static void Menu(){
        ...
        do{
            String menu = "----------------------------------------Menu----------------------------------------\n"
                ...
                +"3.- Imprimir el estacionamiento\n4.- Imprimir cantidad de carros estacionados y la placa del auto en el tope\n"
